...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    while img is not None:
        ...
        reason_id_0, reason_mask_0 = target_dict['word_id_reason_0'], target_dict['word_mask_reason_0']
        reason_id_1, reason_mask_1 = target_dict['word_id_reason_1'], target_dict['word_mask_reason_1']
        reason_id_2, reason_mask_2 = target_dict['word_id_reason_2'], target_dict['word_mask_reason_2']
        iteration = iteration + 1
        data_time.update(time.time() - end)

        outputs = model(img, mask, word_id, word_mask, reason_id_0, reason_mask_0, reason_id_1, reason_mask_1, reason_id_2, reason_mask_2)
